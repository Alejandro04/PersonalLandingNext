            ...
            <section className="post" id="main">
                <div className="post__container container">
                    <section class="items-detail-container" id="post">
                        ...
                        <article>
                            Para estos ejemplos vamos a usar el proyecto explicado <a target="_blank" href="/posts/introduccion-angular-angularmaterial-firebase">En el tutorial anterior</a>
                        </article>
                        <article>
